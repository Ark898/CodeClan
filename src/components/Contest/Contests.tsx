import { getExistingContests, getUpcomingContests } from "src/components/db/contest";
      ...
      <section className="bg-white dark:bg-gray-900 py-8 md:py-12">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingContests.map((contest: { id: Key | null | undefined; title: string; startTime: Date; endTime: Date; }) => (
              <ContestCard
                key={contest.id}
                title={contest.title}
                id={contest.id}
